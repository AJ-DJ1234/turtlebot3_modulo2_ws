...
class HazmatMarkerNode(Node):
    ...
    def add_marker(self):
        ...
        hazmat_x = self.current_position.x + detection_distance * math.cos(yaw + self.detection_angle)
        hazmat_y = self.current_position.y + detection_distance * math.sin(yaw + self.detection_angle)
